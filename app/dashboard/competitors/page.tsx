...
import { getBrands, getCompetitorAnalyses, addCompetitorAnalysis } from '@/lib/storage'
...
export default function CompetitorsPage() {
  ...
  const filteredAnalyses = analyses.filter(a => a.brand_id === brandId)
      ...
      <div className="bg-card border border-border rounded-xl p-6 space-y-4 mb-6">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <select value={brandId} onChange={e => { setBrandId(e.target.value); setSelectedCompetitor(null); setFetchSummary(null); setRealData(null) }}
