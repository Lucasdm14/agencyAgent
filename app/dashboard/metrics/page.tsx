...
function PostCard({ post, rank }: { post: InstagramPost; rank?: number }) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm hover:border-zinc-300 transition-colors">
      {/* Mock thumbnail with gradient */}
      <div className="relative h-36 bg-gradient-to-br from-zinc-200 to-zinc-300 flex items-center justify-center">
        <div className="text-zinc-400 text-center">
          <Instagram size={28} className="mx-auto mb-1 opacity-40" />
          <p className="text-2xs opacity-40 font-mono">{post.type}</p>
        </div>
        {rank && (
